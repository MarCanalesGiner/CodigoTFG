...
- `descripcion_datasets.R`: genera una descripción adicional de algunos conjuntos de datos y mapas de calor basados en información mutua para visualizar la estructura de dependencia entre variables. Usado para la gráfica de la Sección 4.1 (Figura 4.1).

- `comp_medidas_dependencia_M.R`: compara distintas medidas de dependencia entre variables: Pearson, Spearman, Hoeffding, correlación de distancias e información mutua. También genera mapas de calor de las matrices de dependencia. Usado para las gráficas de la Sección 3.5.2. Comparación empírica de las medidas de dependencia (Figuras 3.1 y 3.2).
